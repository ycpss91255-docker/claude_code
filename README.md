...
Tests validate: Claude Code availability, dev tools, system config (non-root user, timezone, locale), absence of Gemini/Codex, and absence of unnecessary tools (tmux, vim, fzf, terminator).
